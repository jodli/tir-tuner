...
L = {
    ...
    "col_share": "Anteil",
    "col_loss_pp": "Verlust",
    "col_loss_share": "davon",
    "col_dominant": "Richtung",
    "col_verdict": "Bewertung",
    "dom_high": "hoch",
    "dom_low": "tief",
    "dom_mixed": "beides",
    ...
    "patch_hint": "→ auch gespeichert als {path}",
    ...
    "clamp_dropped": "verworfen",
    "clamp_confidence": "Sicherheit",
    "clamp_direction": "Richtung",
    "clamp_proposed_value": "Vorschlag",
